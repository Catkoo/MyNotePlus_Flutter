        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Icon(
                  note.isFinished ? Icons.check_circle : Icons.hourglass_bottom,
                  size: 16,
                  color: note.isFinished ? Colors.green : Colors.orange,
                ),
                const SizedBox(width: 6),
                Text(
                  note.isFinished ? "✅ Selesai ditonton" : "⏳ Belum selesai",
                ),
              ],
            ),
            const Spacer(),
                ...
                Expanded(
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      // ✅ Refresh jika kembali dari edit dan ada perubahan
