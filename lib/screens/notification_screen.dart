...
class _NotificationScreenState extends State<NotificationScreen> {
  ...
  void _navigateToDetail(Map<String, dynamic> item) async {
    ...
    // 1. Jalankan proses Mark as Read di background
    if (isGlobal) {
    ...
    // 2. Pindah ke halaman detail
    if (mounted) {
      Navigator.push(
        context,
        MaterialPageRoute(
          // Pastikan nama class di file tujuan adalah NotificationDetailScreen
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return Container(
                ...
                child: InkWell( // Ditambahkan agar seluruh area kartu bisa diklik
                  borderRadius: BorderRadius.circular(20),
